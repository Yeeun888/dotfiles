...
vim.diagnostic.config({
	...
	virtual_text = false, -- Error shows up at the end of the line
	virtual_lines = true, -- Error shows up underneath the line, with virtual lines
